...
## SQL
```sql
SELECT image FROM img2img_controlnet CHARACTER char_bets PROFILE goldenhour_backlight WHERE prompt='cinematic portrait in downtown at sunset' AND seed=123
```
...
```json
{
  ...
  "prompt": {
    ...
    "6": {
      "inputs": {
        "text": "cinematic portrait in downtown at sunset, shot on 50mm lens, Medium Shot, Eye Level, natural light, lighting direction back, warm, glowing edges light, golden hour",
        "clip": [
          "3",
          1
        ]
